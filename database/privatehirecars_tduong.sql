...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2026 at 06:31 PM
...
(2013, 1016, 1, NULL, 'Tan Binh street', 'thành phố hồ chí minh q1', '2026-03-22 16:04:57', 2, '4 Seats', 'Confirmed', 46.75, NULL, 'Cash', '2026-02-24 06:39:52'),
(2014, 1016, NULL, NULL, 'Tan Son Nhat Airport', 'District 1', '2026-03-22 23:00:00', 1, '4-seater', 'Pending', 35.70, NULL, 'Cash', '2026-03-22 15:37:28'),
(2015, 1016, NULL, NULL, 'Tan Son Nhat Airport', 'District 1', '2026-03-24 23:14:00', 8, 'Minibus', 'Cancelled', 98.60, NULL, 'Cash', '2026-03-22 16:15:06'),
(2016, 1016, NULL, NULL, 'Tan Son Nhat Airport', 'District 1', '2026-03-25 12:20:00', 4, 'Minibus', 'Pending', 85.00, NULL, 'Cash', '2026-03-22 16:20:02'),
(2017, 1016, NULL, NULL, 'Tan Son Nhat Airport', 'District 1', '2026-03-25 23:19:00', 8, '4-seater', 'Cancelled', 34.00, NULL, 'Cash', '2026-03-22 16:34:44');
...
INSERT INTO `vehicles` (`VehicleID`, `RegNumber`, `MakeModel`, `Color`, `Capacity`, `IsAvailable`, `CurrentLocation`) VALUES
(1, 'ABC123', 'Toyota Camry', 'Red', 4, 1, NULL),
(2, 'XYZ456', 'Honda Civic', 'Blue', 4, 1, NULL);
...
--
ALTER TABLE `bookings`
  MODIFY `BookingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2018;
